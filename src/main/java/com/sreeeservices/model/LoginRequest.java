...
public class LoginRequest {
    ...
    public LoginRequest(String mobile, String userid, String password, String j_captcha_response,
                        String jSessionId, String server,
    ...
    public void validateUsername() throws InvalidLoginRequestException {
        ...
        if (!(UNDEFINED.equals(userid) || userid == null || userid.isBlank() || userid.isBlank()) && !("ASI7692".equalsIgnoreCase(userid) || "ASI7953".equalsIgnoreCase(userid))) {
